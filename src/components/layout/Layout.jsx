            ...
            <div className="flex flex-col min-h-screen bg-background">
                ...
                <div className="flex flex-1">
                    ...
                    <div className={cn(
                        ...
                        <main className="min-h-[calc(100vh-3rem)] p-3 sm:p-4 md:p-6 overflow-x-hidden bg-gradient-to-br from-emerald-50/50 via-cyan-50/30 to-blue-50/50 dark:from-slate-900 dark:via-slate-900 dark:to-slate-900">
                            <Outlet />
                        </main>
                    </div>
                </div>
